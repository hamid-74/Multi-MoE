...
local_path_1 = "./switch-mnli"
local_path_2 = "./switch-sst2"
...
def merge_models(model1_state_dict, model2_state_dict, sorted_keys, sorted_values):
...
def merge_models_emre(model1_state_dict, model2_state_dict, sorted_keys, sorted_values):
    merged_model_state_dict = model2_state_dict.copy()
...
# Merge the experts
merged_model_base_state_dict = merge_models(model1_state_dict, model2_state_dict, sorted_keys, sorted_values)
...
merged_model.save_pretrained("merged-mnli")

print("Merged model saved in 'merged-base' folder.")
