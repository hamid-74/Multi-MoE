...
rates = [0.05, 0.05, 0.05, 0.05, 0.05, 0.005, 0.010,  0.015, 0.020, 0.025, 0.030,  0.035,  0.040,  0.045,  0.050,  0.055, 0.060, 0.065, 0.070, 0.075, 0.080]
...
for rate in rates:
    ...
    model_configs = {
        ...
        "mistralai/Mixtral-8x7B-v0.1": {"rate": rate},
    }
    ...
    output_filename = f"results/qos/multi-MoE_run2/qos_metrics_rate_{rate:.3f}.json"
